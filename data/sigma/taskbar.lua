...
cleartaskbar = function()
	...
	if SelectionCount() == 0 then
		...
		BindButton("command_modal_icon01", toolbar_commands[1][2], "doteamobjmodal",  "teamobjtooltip", "ui/ingame/ping.tga", 1)

		BindButton("command_modal_icon02", toolbar_commands[2][2], "selectlab", "selectlabtooltip", "ui/ingame/labthumb.tga", 2)

		BindButton("command_modal_icon03", toolbar_commands[3][2], "selectnextgroundcombiner", "nextcctooltip", "ui/ingame/nextchamber.tga", 3)

		BindButton("command_modal_icon04", toolbar_commands[4][2], "selectallidlehenchman", "allidletooltip", "ui/ingame/selectidle.tga", 4)

		BindButton("command_modal_icon05", toolbar_commands[5][2], "selectallcombatunitsinworld", "allunitstooltip", "ui/ingame/formations.tga", 5)
	...
	elseif
	   ...
	   type == Animal_EC or
	   type == Fire_EC or
	   type == ResourceGather_EC or
	   type == BrambleFence_EC then
	...
	if FastSpeedAllowed() == 1 then
		...
		if IsFastSpeed() == 1 then
			...
			BindButton( "command_normal_icon01", playback_commands[1][2], "dospeedfast", "playbacktooltip", playback_commands[1][4], 1 )
		
		else
		
			-- Show fast forward button (fast speed)
			BindButton( "command_normal_icon01", playback_commands[2][2], "dospeednormal",   "playbacktooltip", playback_commands[2][4], 2 )
